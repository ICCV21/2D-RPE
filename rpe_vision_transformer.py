...
from timm.models.vision_transformer import _cfg, default_cfgs, _conv_filter,\
                                           Mlp, PatchEmbed, HybridEmbed

from rpe_2d import build_rpe
...
class VisionTransformer(nn.Module):
    """ Vision Transformer with support for patch or hybrid CNN input stage
                           and 2D relative position encoding
    """
